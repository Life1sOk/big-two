...
import { signInSuccess, signInFaile, signUpSuccess, signUpFailed, signOutSuccess, signOutFailed } from './user.action';
...
export function* isEmailOk({ payload: { email, password } }) {
    try{
...
export function* onEmailSignIn() {
    yield takeLatest(USER_ACTION_TYPES.EMAIL_SING_IN_START, isEmailOk)
}

export function* onGoogleSignIn() {
    yield takeLatest(USER_ACTION_TYPES.GOOGLE_SING_IN_START, isGoogleOk)
}
