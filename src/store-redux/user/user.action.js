...
export const emailSignInStart = (email, password) => {
   return createAction(USER_ACTION_TYPES.EMAIL_SING_IN_START, {email, password})
}

export const signInSuccess = (user) => {
   return createAction(USER_ACTION_TYPES.SING_IN_SUCCESS, user)
}

export const signInFaile = (error) => {
   return createAction(USER_ACTION_TYPES.SING_IN_FAILED, error)
}
